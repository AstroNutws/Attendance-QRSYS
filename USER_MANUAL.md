...
* **Desktop Admin Setup (v2.1.0):** [Watch on YouTube](https://youtu.be/ZcIJaQYzTzw)
* **Mobile Scanner Guide (v1.9.0):** [Watch on Streamable](https://streamable.com/a4n7ic)
...
2.  **Database Sync:** Ensure the "Cloud Sync Status" in the bottom corner shows **VERIFIED**.
3.  **Announcement Setup:** Use the **Announcements Dashboard** to post any school-wide alerts; these will be visible to staff during the scanning process.

## 2. Managing Student Data

The **v2.1.0** update includes smart filtering to reduce data entry errors:
...
For the best performance and "Zero-Lag" results:
...
* **Autofocus:** If the scan is blurry, tap the center of the screen to trigger the high-speed autofocus.

### PC Client
* If using a webcam for scanning, ensure the scanning area is well-lit to prevent "Green Screen" or resolution errors.
...
**AstroNutws Support** 📧 [samongud@gmail.com](mailto:samongud@gmail.com)
